...
export class TicketEntity1706978545919 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        queryRunner.query(
            `CREATE TABLE public.ticket_entity (
                ...
                CONSTRAINT "FK_872bf60722bdaff3118a1d2342c" FOREIGN KEY (status) REFERENCES public.ticket_status(id),
                CONSTRAINT "FK_a60cb0c083243ffb156246ec0e1" FOREIGN KEY (assignee) REFERENCES public.user_entity(id)
            );`
        );
    }
